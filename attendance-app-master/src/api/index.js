...
if (localStorage._students === undefined) {
  localStorage.setItem('_students', JSON.stringify(
    [
      { lastName: 'Jones', firstName: 'Jessica', id: '7ae6c6e0-8912-11e6-ae55-995190a07d86', atSchool: false , entries: [
        {text: "Doctor's appointment", date: "2016-10-06", time: "12:30"}
      ], rollCallPresent: false },
      { lastName: 'Cage', firstName: 'Luke', id: '8ze6c6e0-8912-11e6-ae55-995190a07d86', atSchool: true , entries: [], rollCallPresent: true },
      { lastName: 'Carter', firstName: 'Sophia', id: '9pz3c6e0-8912-11e6-ae55-995190a07z56', atSchool: true , entries: [], rollCallPresent: false },
      { lastName: 'Owens', firstName: 'Terrel', id: '2ef3c6e0-8912-11e6-ae55-995190a07d22', atSchool: true , entries: [], rollCallPresent: false },
      { lastName: 'McDonald', firstName: 'Ronald', id: '2eg3c1e0-8912-11e6-ae55-995190a07d85', atSchool: true , entries: [], rollCallPresent: false },
      { lastName: 'Parker', firstName: 'Sarah', id: '9pq5c1e0-8912-21e6-ae53-110260a07d44', atSchool: true , entries: [], rollCallPresent: false },
    ]
  ));
}
...
export function getStudents() {
  const promise = new Promise((resolve, reject) => {
    setTimeout(() =>
      resolve(JSON.parse(localStorage.getItem('_students')) || []), 180);
  });
